...
It lists what can be shared, captures each screen for a few seconds, says
how fast this computer can encode the share, and then listens to the
computer's sound for three seconds. Play some music while it runs: the
"loudest" level it prints should then be well above silence. Send
